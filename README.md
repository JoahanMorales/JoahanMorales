# 👋 Hola, soy Joahan Morales

<div align="center">
  
  [![Typing SVG](https://readme-typing-svg.demolab.com?font=Fira+Code&size=22&duration=3000&pause=1000&color=58A6FF&center=true&vCenter=true&width=440&lines=Backend+Developer+%F0%9F%9A%80;Estudiante+de+Ingenier%C3%ADa+Inform%C3%A1tica;Apasionado+por+Java+y+Spring+Boot)](https://git.io/typing-svg)
  
</div>

## 🚀 Sobre mí

Soy un desarrollador backend especializado en **Java**, con formación técnica en programación y actualmente estudiando Ingeniería en Informática. Me apasiona construir sistemas escalables y eficientes, y estoy en constante aprendizaje de nuevas tecnologías.

```java
public class JoahanMorales {
    private String rol = "Backend Developer";
    private String educacion = "Ingeniería en Informática";
    private String[] lenguajes = {"Java", "Python", "JavaScript"};
    private String[] frameworks = {"Spring Boot", "React"};
    private String[] databases = {"PostgreSQL", "MongoDB", "MySQL"};
    
    public void presentacion() {
        System.out.println("¡Hola! Construyendo el futuro una línea de código a la vez 🚀");
    }
}
```
...
<!-- Descomenta y edita cuando tengas proyectos para mostrar
<div align="center">

| Proyecto | Descripción | Tecnologías |
|----------|-------------|-------------|
| **[Proyecto 1](#)** | Sistema de gestión... | ![Java](https://img.shields.io/badge/-Java-ED8B00?style=flat&logo=openjdk) ![Spring](https://img.shields.io/badge/-Spring-6DB33F?style=flat&logo=spring) |
| **[Proyecto 2](#)** | API REST para... | ![Python](https://img.shields.io/badge/-Python-3776AB?style=flat&logo=python) ![PostgreSQL](https://img.shields.io/badge/-PostgreSQL-316192?style=flat&logo=postgresql) |
...
![](https://komarev.com/ghpvc/?username=JoahanMorales&label=Visitas+al+Perfil&color=0e75b6&style=flat)
